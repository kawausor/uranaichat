...
YOUR_ICON = 'https://3.bp.blogspot.com/-Ii9ZSrIPi4Q/VLeqoTyW8wI/AAAAAAAAqek/DRRwTg_9Ao4/s800/love_woman.png'
MAN_ICON = 'https://3.bp.blogspot.com/-xd3rBKSN-mo/VLeqnNz-mNI/AAAAAAAAqeQ/FU17z93NSp0/s800/love_man.png'
...
def uranai(input_text):
  ...
  if 'name' in frame and 'birthday' in frame and 'name2' not in frame:
    frame['asking'] = 'name2' # 名前をたずねる  
    return 'あなたと相性を占いたい人の名前は？'

  if 'name' in frame and 'birthday' in frame and 'name2' in frame and 'birthday2' not in frame:
    frame['asking'] = 'birthday2' # 誕生日をたずねる    
    return '相性を占いたい人の誕生日は？'

  if 'name' in frame and 'birthday' in frame and 'name2' in frame and 'birthday2' in frame:
    # 占います
    number = hash(frame['birthday']+frame['birthday2']) % 10
    if number > 0:
      return 'あなたとその人の相性はとても良い'
    return 'あなたとその人の相性は良い　その人と出かけるともっと相性が良くなるかも！'
